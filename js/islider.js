    ...
    addBtn: function () {
      if (!this.isVertical) {
        ...
        for (var i = 0; i < 2; i++) {
          ...
          //尝试用touch事件替换click
          // if($(".islider-btn-outer")){
          //   alert('找到了');
          // }
          // var ifButtonTouch=false;
          // $(".islider-btn-outer").on('touchstart touchend',function(event){
          //   console.log('添加了监听事件');
          //   if(event.type=='touchstart'){
          //     console.log('touch start ');
          //     ifButtonTouch=true;
          //   }
          //   if(event.type=='touchend' && ifButtonTouch){
          ...
          //   self.slideTo(self.slideIndex + dir);
          // });
          $(btnOuter[i]).on('touchstart',function(){
            var dir = parseInt(this.getAttribute('dir'), 10);
            self.slideTo(self.slideIndex + dir);
          });
          console.log('执行完touch事件');
